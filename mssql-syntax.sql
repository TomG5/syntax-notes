...
ALTER USER user1 SET timezone = '';     | User level change

    -- Change tables
ALTER TABLE mytable ADD new_column INT;
ALTER TABLE mytable ALTER COLUMN my_column TEXT;
...
INSERT INTO mytable (myname, age, salary, birth_day) VALUES ('Joe Doe', 32, 55000, CAST('1990-01-01' AS DATE)), ('Jane Doe', 30, 56000, CAST('1994-01-01' AS DATE));

    -- Update data in table
UPDATE mytable SET begin_date = CAST('2021-01-01' AS DATE) WHERE begin_date IS NULL;
